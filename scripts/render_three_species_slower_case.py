...
from utilities import simulate_relaxation_multispecies, three_species_slower_relaxation_case


def main() -> None:
    case = three_species_slower_relaxation_case()
    ...
    output_path = output_dir / "three_species_slower_relaxation.png"
    ...
    axes[0].set_title("Slower Three-Species Relaxation")
